...
var BubbleManager = require('./bubble');
var Renderer = require('./renderer');
var Map = require('./map');
var Animation = require('./animation');
var Sprite = require('./sprite');
var AnimatedTile = require('./tile');
...
var Game = Class.extend({
    ...
    tick: function() {
        ...
        if(!this.isStopped) {
            //FIXME
            //Util.requestAnimFrame(this.tick.bind(this));
            //Util.requestAnimFrame(Util.bind(this.tick, this));
            //Util.requestAnimFrame(this.tick);
